...
<html lang="en">
 ...
 <head>
        ...
        <meta charset="utf-8" />
        <title>Coming Soon | PepeLeads</title>
                    ...
                    <div class="col-lg-8">
                        <div class="text-center py-4 py-sm-5">
                            ...
                            <div class="mb-5">
                                ...
                                <h3 class="text-white mt-5">PepeLeads</h3>
                            </div>
                            <h3 class="text-white mt-5">Let's get started with PepeLeads</h3>
                            <p class="text-white-50 font-size-16">Monotize your content with PepeLeads.com</p>
                            
                            <div data-countdown="2022/08/31" class="counter-number mt-5"></div>
