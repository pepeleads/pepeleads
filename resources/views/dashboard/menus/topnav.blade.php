            ...
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link  arrow-none" href="/sites" role="button">
                            <i data-feather="globe"></i><span data-key="t-horizontal">Sites</span>
                        </a>
                    </li>

                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-pages" role="button">
                            <i data-feather="grid"></i><span data-key="t-apps">Offers</span> <div class="arrow-down"></div>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                            <a href="apps-calendar.html" class="dropdown-item" data-key="all-offers">All Offers</a>
                            <a href="apps-chat.html" class="dropdown-item" data-key="pending-offers">Pending Offers</a>
                            <a href="apps-chat.html" class="dropdown-item" data-key="approved-offers">Approved Offers</a>
                        </div>
                    </li>

                    <li class="nav-item ">
                        <a class="nav-link arrow-none" href="/reports"  role="button">
                            <i data-feather="calendar"></i><span data-key="t-dashboards">Reports</span>
                        </a>
                    </li>

                    <li class="nav-item dropdown">
                        <a class="nav-link arrow-none" href="/integrations" id="topnav-dashboard" role="button">
                            <i data-feather="code"></i><span data-key="t-dashboards">Integrations</span>
                        </a>
                    </li>

                    {{-- <li class="nav-item dropdown">
                        <a class="nav-link arrow-none" href="/advertise" id="topnav-dashboard" role="button">
                            <i data-feather="airplay"></i><span data-key="t-dashboards">Advertise</span>
                        </a>
                    </li> --}}

                    <li class="nav-item dropdown">
                        <a class="nav-link arrow-none" href="/finance" id="topnav-dashboard" role="button">
                            <i data-feather="credit-card"></i><span data-key="t-dashboards">Finance</span>
                        </a>
                    </li>

                    <li class="nav-item dropdown">
                        <a class="nav-link arrow-none" href="/profile" id="topnav-dashboard" role="button">
                            <i data-feather="user"></i><span data-key="t-dashboards">Profile</span>
                        </a>
                    </li>

                    <li class="nav-item dropdown">
                        <a class="nav-link arrow-none" href="/refer" role="button">
                            <i data-feather="dollar-sign"></i><span data-key="t-dashboards">Refer</span>
                        </a>
                    </li>
                    {{-- 
                        <li class="nav-item dropdown">
