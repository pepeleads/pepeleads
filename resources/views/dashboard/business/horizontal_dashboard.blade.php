                                            ...
                                            <div>
                                                <div class="balance-item d-flex justify-content-between align-items-center mb-3">
                                                    <div class="d-flex align-items-center">
                                                        <div class="balance-icon purple-bg-light rounded-2 me-2 d-flex align-items-center justify-content-center p-1">
                                                             <i class="mdi mdi-bell"></i>
                                                        </div>
                                                        <div class="balance-name">
                                                            <a href="{{ $notifications->notification_link }}" class="text-dark" target="_blank">
                                                                <h5 class="font-size-12 mb-0">{{ $notifications->notification_title }}</h5>
                                                            </a>
                                                            <p class="text-muted font-size-10 mb-0">{{ $notifications->notification_description }}
                                                            @if($notifications->notification_link)
                                                                <a href="{{ $notifications->notification_link }}" class="badge bg-primary" target="_blank">View</a>
                                                            @endif
                                                    ...
                                                    <div class="text-sm">
                                                        <strong class="font-size-10">{{ $notifications->created_at}}</strong>
                                                    </div>
                                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="/offer_details/{{ base64_encode($offers->id) }}" target="_blank" class="btn btn-primary btn-sm">View</a></td>
                                    </tr>
                                    @endforeach
                                    </tbody>
                                </table>
