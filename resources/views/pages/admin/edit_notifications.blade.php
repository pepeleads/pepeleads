                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="col-lg-8">
                                    <form action="/edit_notifications" method="POST">
                                        @csrf
                                        <div>
                                            <div class="mb-3">
                                                <label for="notification_id" class="form-label">Notification Id</label>
                                                <input class="form-control" type="number" value="" placeholder="Notification Id" name="notification_id" id="notification_id" required>
                                            </div>
                                            <div class="mb-3">
