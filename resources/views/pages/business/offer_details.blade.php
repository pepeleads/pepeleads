                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><img src="@if(($offer?->offers?->image_url == '/img/reward.png')){{$offer?->offers?->image_url}}@else/image/{{$offer?->offers?->id}}@endif"  height="30px" class="m-3"/>{{ $offer?->offers?->name}}</h4>
                            <p class="card-title-desc">{{ $offer?->offers?->description}}</p>
                        </div>
                         ...
                         <div class="border-top">
                            ...
                            <div class="row">
                                ...
                                $ {{number_format(($offer?->offer?->credit * $offer?->offer->rate?->rate?->network_rate) / 100, 4)}}
                                @else
                                 $ 0.00
                                 @endif
                                </div>
