                                        ...
                                        <div>
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" 
                                                    placeholder="Site Name" value="{{ $site->site_name }}" name="site_name" id="site_name" required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" placeholder="Site Domain"
                                                    id="domain_name"  value="{{ $site->domain_name}}"  name="domain_name" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="post_back_link" class="form-label">Postback</label>
                                                <input class="form-control" type="text" name="post_back_link" id="post_back_link"
                                                    placeholder="https://"   value="{{ $site->post_back}}"   required>
                                            </div>
                                            {{-- <div class="mb-3">
                                                <label for="virtual_currency" class="form-label">Offerwall Virtual
                                                    Currency</label>
                                                <input class="form-control" type="text" 
                                                    placeholder="e.g. Points, credits"   value="{{ $site->virtual_currency }}" id="virtual_currency" name="virtual_currency"  required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="currency_value" class="form-label">Offerwall Currency
                                                    multiplier</label>
                                                <input class="form-control" type="tel" placeholder="value per $1"
                                                    id="currency_value" value="{{ $site->currency_value }}"  name="currency_value" required>
                                            </div> --}}
                                            <div class="mb-3">
                                                <label for="description" class="form-label">Description</label>
                                                <input class="form-control" type="text" placeholder="Short Description"
                                                    id="description"  value="{{ $site->description }}"  name="description" >
                                            </div>
                                            <div class="mb-3">
